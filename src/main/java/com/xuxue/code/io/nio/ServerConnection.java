 ...
 */
public class ServerConnection<Request extends Serializable,Response extends Serializable> {
    ...
    public synchronized void writeResponse(Response t)throws IOException{
        byte[] data= SerializableTools.serializableToBytes(t);
        write(data);
    }
    ...
    public synchronized Request readRequest()throws IOException{
        ...
        byte[] data=this.data;
        try{
            return (Request) SerializableTools.bytesToSerializable(data);
